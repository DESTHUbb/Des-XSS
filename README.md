...
# Example
As you see in ![s1](https://github.com/lwzSoviet/download/blob/master/images/s1.png)the poc is `URL`,That means use the payload `xssjs%22%3B` in param "proxyAccount":  
